...
async def background_worker():
    ...
    try:
        ...
        # capture the worker's exception group for later re-raising
        background_errors.extend(eg.exceptions)
    ...
    if background_errors:
        ...
        raise RuntimeError(f"Background task failures: {background_errors}")
